    ...
    'objectlist|10': [
      {
        ...
        'WorkstationName|1':['自动机01','自动机02','自动机03','自动机04','自动机05','自动机06'],
        ...
        restTime: Mock.mock('@natural(10, 100)'), //剩余时间
        Status: Mock.mock('@natural(0, 3)'),
        pro_progress:Mock.mock('@natural(10, 100)'),
        rej_progress:Mock.mock('@natural(10, 100)'),
      },
    ],
  },
  msg: '',
