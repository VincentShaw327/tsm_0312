        ...
        <div ref={this.handleRef}>
          ...
          >
            ...
            <Geom type="interval"
                ...
                // shape='field'
                // tooltip={tooltip}
                tooltip={['range*field*task', (range,field,task) => {
                    console.log('task*range',range,field,task);
                    let startTime=moment(range[0]).format('YYYY/MM/DD HH:mm:ss'),
                        endTime=moment(range[1]).format('YYYY/MM/DD HH:mm:ss');
                  return {
