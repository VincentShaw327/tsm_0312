...
import YieldDataTable from './components/YieldDataTable';
import YieldTrackChart from './components/YieldTrackChart';
const FormItem = Form.Item;

export default class TYieldTrack extends Component {
    ...
    getTrackReport(){
        ...
        TPostData( '/api/TReport/device_report', "GetDeviceDayTrackReport", dat,
            ( res ) => {
                var list = [];
