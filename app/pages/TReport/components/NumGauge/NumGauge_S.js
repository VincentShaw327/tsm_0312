...
@autoHeight()
export default class NumGauge_S extends React.Component {
  render() {
    ...
    return (
        <Chart height={height} data={percent} scale={cols}
         ...
         <Axis name='value'
           ...
           label={{
               offset: -10,
               textStyle: {fontSize: 12,fill: 'rgba(0, 0, 0, 0.25)',textAlign: 'center',textBaseline: 'middle'}
            }}
           subTickCount={4}
           subTickLine={{length: -5,stroke: '#fff',strokeOpacity: 1}}
