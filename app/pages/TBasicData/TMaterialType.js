...
import { fetchMaterialTypeList } from 'actions/wms';
...
export default class TMaterialType extends Component {
    ...
    componentWillMount(){
        // this.getTableList();
        this.props.dispatch( fetchMaterialTypeList( { current: 1 }, ( respose ) => {} ) )
    }
    ...
    getTableList(que){
        ...
        TPostMock( '/mtrl_type', "ListActive", dat,
            (res) => {
                var list = [];
    ...
    render() {
        ...
        const { mtrlTypeList, total, loading } = this.props.mtrlType;
