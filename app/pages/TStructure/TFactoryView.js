...
import { Table, Menu, Icon, Badge, Dropdown,message,Divider,Popconfirm,List, Avatar} from 'antd';
                ...
                <div className="cardContent">
                    ...
                    <List
                      ...
                      renderItem={item => (
                        <List.Item
                          key={item.title}
                          actions={[<IconText type="info-circle" text="详情" />, <IconText type="like-o" text="156" />, <IconText type="message" text="2" />]}
